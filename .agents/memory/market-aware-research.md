...
Research must use product, service, pricing, warranty, and support evidence applicable to the user's inferred market. Do not substitute another country's brand site or regional terms. If local official evidence is unavailable, use a reputable local independent source or mark the claim unavailable.
