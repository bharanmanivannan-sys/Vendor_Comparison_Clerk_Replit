 ...
 */
export const createStripeCheckoutHeaderXTenantIdMax = 200;



export const CreateStripeCheckoutHeader = zod.object({
  "X-Tenant-Id": zod.string().min(1).max(createStripeCheckoutHeaderXTenantIdMax).describe('Exact tenant being managed; the Clerk user must be an owner or admin member.')
})
 ...
 */
export const reconcileStripeBillingHeaderXTenantIdMax = 200;



export const ReconcileStripeBillingHeader = zod.object({
  "X-Tenant-Id": zod.string().min(1).max(reconcileStripeBillingHeaderXTenantIdMax).describe('Exact tenant being managed; the Clerk user must be an owner or admin member.')
})

export const reconcileStripeBillingBodyCheckoutSessionIdMax = 255;



export const ReconcileStripeBillingBody = zod.object({
  "checkoutSessionId": zod.string().min(1).max(reconcileStripeBillingBodyCheckoutSessionIdMax).optional()
})

export const ReconcileStripeBillingResponse = zod.object({
