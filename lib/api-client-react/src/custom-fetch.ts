 ...
 *
 * Web applications may also use this when the authentication SDK can refresh
 * short-lived bearer tokens after a tab has been inactive.
 */
...
export async function customFetch<T = unknown>(
  ...
  const cache = init.cache ?? (
    (method === "GET" || method === "HEAD") && typeof window !== "undefined"
      ? "no-store"
      : undefined
  );
