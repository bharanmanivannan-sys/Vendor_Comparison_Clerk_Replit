...
try {
  await build({
    entryPoints: [
      ...
      "src/services/historyRecovery.test.ts",
  ...
  const result = spawnSync(
    process.execPath,
    ["--test", join(outdir, "app.test.js"), join(outdir, "lib/analysis.test.js"), join(outdir, "services/apiKeys.test.js"), join(outdir, "services/historyRecovery.test.js"), join(outdir, "services/idempotency.test.js"), join(outdir, "services/visitorSessions.test.js"), join(outdir, "routes/commercial.test.js"), join(outdir, "routes/comparisons.test.js"), join(outdir, "routes/stripeIsolation.test.js")],
