...
function AnalysisPage() {
  ...
  const compareAlternative = (insight: string) => {
    ...
    window.sessionStorage.setItem(
      ...
      `Compare ${comparison.recommendation} with ${alternative}. Use the same decision context and criteria as this assessment: ${comparison.prompt}`,
    );
